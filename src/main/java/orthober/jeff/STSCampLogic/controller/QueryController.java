...
public class QueryController {
    ...
    //This classed use to verify JSON consumption of query objects

    @RequestMapping(value = "/query")
    public void campsite(@RequestBody Query query) {
    		System.out.println("Just got a request for /query.");
    		System.out.println(query.getSearch().getStartDate());
    		System.out.println(query.getSearch().getEndDate());
